 ...
 * {@link IObexConnectionHandler#onConnect(BluetoothDevice, BluetoothSocket)} will be called.<br>
 * In both cases the {@link BluetoothMnsObexServerSockets} object have terminated, and a new must be created.
 */
public class BluetoothMnsObexServerSockets {
    private final String TAG;
    private static final String STAG = "BluetoothMnsObexServerSockets";
    ...
    private BluetoothMnsObexServerSockets(IObexConnectionHandler conHandler,
            BluetoothServerSocket rfcommSocket,
            BluetoothServerSocket l2capSocket) {
        mConHandler = conHandler;
        mRfcommSocket = rfcommSocket;
        mL2capSocket = l2capSocket;
        TAG = "BluetoothMnsObexServerSockets" + sInstanceCounter++;
    }
     ...
     * @return a reference to a {@link BluetoothMnsObexServerSockets} object instance.
     * @throws IOException if it occurs while creating the {@link BluetoothServerSocket}s.
     */
    public static BluetoothMnsObexServerSockets create(IObexConnectionHandler validator) {
     ...
     * @throws IOException if it occurs while creating the {@link BluetoothServerSocket}s.
     */
    public static BluetoothMnsObexServerSockets createInsecureWithFixedChannels(IObexConnectionHandler
     ...
     * @throws IOException if it occurs while creating the {@link BluetoothServerSocket}s.
     */
    public static BluetoothMnsObexServerSockets createWithFixedChannels(IObexConnectionHandler validator,
     ...
     * {@link #getRfcommChannel()} in {@link BluetoothMnsObexServerSockets}.
     * @param validator a reference to the {@link IObexConnectionHandler} object to call
     *                  to validate an incoming connection.
     ...
     */
    private static BluetoothMnsObexServerSockets create(
        ...
        if (initSocketOK) {
            ...
            BluetoothMnsObexServerSockets sockets = new BluetoothMnsObexServerSockets(validator, rfcommSocket, l2capSocket);
            sockets.startAccept();
            return sockets;
        } else {
                ...
                while (!mStopped) {
                    ...
                    try {
                       ...
                       if (connSocket == null) {
                         ...
                         */
                        boolean isValid = BluetoothMnsObexServerSockets.this.onConnect(device, connSocket);
                        ...
                        if(isValid == false) {
                            ...
                            BluetoothMapRfcommTransport obexTrans =
                                    new BluetoothMapRfcommTransport(connSocket);
                        ...
                        if(mStopped == true) {
                            ...
                            Log.w(TAG, "Accept exception for " +
                                    mServerSocket, ex);
                            BluetoothMnsObexServerSockets.this.onAcceptFailed();
                        }
                        mStopped=true;
                    }
                } // End while()
